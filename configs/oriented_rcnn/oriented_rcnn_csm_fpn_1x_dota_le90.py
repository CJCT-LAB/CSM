...
model = dict(
    ...
    backbone=dict(
        ...
        drop_path_rate=0.1,
        depths=[3,4,6,3],
        lsm=[[0,2,1],[0,2,1,0],[0,2,1,0,2,1],[0,2,1]],
        d_conv=[[3,5,7],[3,5,7,3],[3,5,7,3,5,7],[3,5,7]],
        local_conv=[False,False,False,False],
...
# dota_ms_rr
data_root_ms = '/mnt/share/DOTA/split_ms_dota_v1.0/'
data_root_ss = '/mnt/csip-111/DOTA/split_ss_dota_v1.0_1024/'
angle_version = 'le90'
img_norm_cfg = dict(
